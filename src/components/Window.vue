...
<svg :width="width+200" :height="parseInt(height)+100">
    ...
    <g transform="translate(0,55)" id="okno">
        ...
        <sash :transform="'translate('+sash1.x+','+sash1.y+')'" :width="sash1.width" :height="sash1.height" :sashThickness="sashThickness"></sash>
        <sash :transform="'translate('+sash2.x+','+sash2.y+')'" :width="sash2.width" :height="sash2.height" :sashDiff="sashDiff" :sashThickness="sashThickness"></sash>

        <rect :x="width/2 + 11" :y="height / 2" width="18.823529411764802" height="18.823529411764802" stroke="#999999" stoke-width="0.2" id="Skdeh79amy" style="fill-opacity: 0;"></rect>
        <rect :x="width/2 + 14.6" :y="height / 2 + 4" width="11.3" height="56.5" fill="#ffffff" stroke="#999999" stoke-width="0.2" id="Skdeh79amz" style="fill-opacity: 1;"></rect>

        <rect :x="width/2 - 28" :y="height / 2" width="18.823529411764802" height="18.823529411764802" stroke="#999999" stoke-width="0.2" id="Skdeh79amy" style="fill-opacity: 0;"></rect>
        <rect :x="width/2 - 24.4" :y="height / 2 + 4" width="11.3" height="56.5" fill="#ffffff" stroke="#999999" stoke-width="0.2" id="Skdeh79amz" style="fill-opacity: 1;"></rect>
    </g>
